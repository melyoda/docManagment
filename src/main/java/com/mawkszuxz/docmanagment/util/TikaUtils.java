...
public class TikaUtils {
    ...
    /**
     * extractData:
     * args (InputStream stream, String originalFileName)
     * return DocumentData record
     * */
    public static DocumentData extractData(InputStream stream, String originalFilename) throws TikaException, IOException, SAXException {
        try {
            ...
            if(content != null && !content.isEmpty()) {
                ...
                System.out.println("[TikaUtils] Content preview (first 500 chars): " +
                        content.substring(0, Math.min(content.length(), 500)).replace("\n", " "));
            }else {
